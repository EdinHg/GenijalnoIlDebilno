...
\section{Prijedlog tehnologija za implementaciju}

% Opisati sve tehnologije koje se predlažu za implementaciju informacionog sistema (frontend, backend, baza podataka, eventualno dodatni elementi poput druge vrste aplikacije, eksternih API servisa i sl.). Prikazati UML dijagram raspoređivanja sistema.
...
\begin{itemize}  
    ...
    \end{itemize}%todo mislim da ovog nema u funkcionalnostima
